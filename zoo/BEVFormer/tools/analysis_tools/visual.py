...
def make_corruption(img, corruption_name):
    ...
    new_img = corrupt(img, corruption_name=corruption_name, severity=5)
...
if __name__ == '__main__':
    nusc = NuScenes(version='v1.0-mini', dataroot='/data1/data/shaoyuan/nuscenes', verbose=True)
    # render_annotation('7603b030b42a4b1caa8c443ccc1a7d52')
    bevformer_results = mmcv.load('/home/cihangxie/shaoyuan/BEVFormer/test/bevformer_base/Sun_Oct__2_03_44_07_2022/pts_bbox/results_nusc.json')
    sample_token_list = list(bevformer_results['results'].keys())

    save_path = os.path.join('visual', corruptions)
    if not os.path.isdir(save_path): os.makedirs(save_path)
    
    for id in range(0, 10):
        out_path= os.path.join(corruptions, sample_token_list[id])
