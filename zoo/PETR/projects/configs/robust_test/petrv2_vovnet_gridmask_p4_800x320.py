...
test_pipeline = [
    ...
    dict(type='Custom_LoadMultiViewImageFromMultiSweepsFiles', sweeps_num=1, to_float32=True, pad_empty_sweeps=True, sweep_range=[3,27],
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=anno_root + 'mmdet3d_nuscenes_30f_infos_train.pkl',
    ...
    val=dict(
        ...
        ann_file=anno_root + 'mmdet3d_nuscenes_30f_infos_val.pkl', 
        classes=class_names, 
        modality=input_modality),
    test=dict(        
        type=dataset_type, 
