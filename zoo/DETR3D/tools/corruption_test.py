...
def custom_multi_gpu_corruption_test(model, data_loader, corruption_type, severity, tmpdir=None, gpu_collect=False):
    ...
    Args:
        ...
        corruption_type (str): Image corruption to be used
    ...
    corrupt = CORRUPTIONS.build(dict(type=corruption_type, severity=severity, norm_config=norm_config))
