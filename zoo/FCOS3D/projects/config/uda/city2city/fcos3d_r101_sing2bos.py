...
replace_dict = {"/nvme/konglingdong/data/sets/nuScenes/": data_root,
                "/nvme/share/data/sets/nuScenes/": data_root}
...
data = dict(
    ...
    train=dict(
        data_root=data_root,
        ann_file=anno_root + 'nuscenes_infos_sing_train_mono3d.coco.json',
        img_prefix=data_root,
        pipeline=train_pipeline),
    val=dict(
        type='UDANuScenesMonoDataset',
        data_root=data_root,
        ann_file=anno_root + 'nuscenes_infos_sing_val_mono3d.coco.json',
