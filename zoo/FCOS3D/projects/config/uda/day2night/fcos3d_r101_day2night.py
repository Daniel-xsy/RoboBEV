_base_ = [
    '/mnt/petrelfs/konglingdong/models/mmdetection3d/configs/_base_/datasets/nus-mono3d.py', 
    '/mnt/petrelfs/konglingdong/models/mmdetection3d/configs/_base_/models/fcos3d.py',
    '/mnt/petrelfs/konglingdong/models/mmdetection3d/configs/_base_/schedules/mmdet_schedule_1x.py', 
    '/mnt/petrelfs/konglingdong/models/mmdetection3d/configs/_base_/default_runtime.py'
]
...
anno_root = '/mnt/petrelfs/konglingdong/models/RoboBEV/data/uda/'
