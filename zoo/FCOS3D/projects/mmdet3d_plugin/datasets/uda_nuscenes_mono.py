...
class UDANuScenesMonoDataset(CocoDataset):
    ...
    def get_attr_name(self, attr_idx, label_name):
        ...
        if label_name == 'car' or label_name == 'bus' \
            ...
            if AttrMapping_rev2[attr_idx] == 'vehicle.moving' or \
                ...
                return UDANuScenesMonoDataset.DefaultAttribute[label_name]
    ...
    def _evaluate_single(self,
        ...
        from custom_nuscenes.eval.detection.evaluate import NuScenesEval
