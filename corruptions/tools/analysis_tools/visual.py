...
if __name__ == '__main__':
    corruption = 'Snow'
    nusc = NuScenes(version='v1.0-trainval', dataroot='/nvme/share/data/sets/nuScenes', verbose=True)
    # render_annotation('7603b030b42a4b1caa8c443ccc1a7d52')
    bevformer_results = mmcv.load('/nvme/konglingdong/models/RoboDet/zoo/BEVFormer/test/bevformer_base/Mon_Jan_16_10_12_31_2023/pts_bbox/results_nusc.json')
    sample_token_list = list(bevformer_results['results'].keys())

    save_path = os.path.join('visual', corruption)
