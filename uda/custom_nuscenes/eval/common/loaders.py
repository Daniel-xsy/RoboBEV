...
from custom_nuscenes.utils.splits import create_splits_scenes
...
def load_gt(nusc: NuScenes, eval_split: str, box_cls, verbose: bool = False) -> EvalBoxes:
    ...
    assert eval_split in list(splits.keys()), \
                f'eval split should in {list(splits.keys())}, now {eval_split}'
